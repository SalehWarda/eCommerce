...
class Order extends Model
{
    ...
    public function statusWithLabel()
    {
        switch ($this->order_status){
            ...
            case 5: $result ='<label class="badge badge-dark">Canceled</label>' ; break;
            case 6: $result ='<label class="badge badge-dark">Refund Requested</label>' ; break;
            case 7: $result ='<label class="badge badge-dark">Refunded</label>' ; break;
            case 8: $result ='<label class="badge badge-slate">Returned Order</label>' ; break;
