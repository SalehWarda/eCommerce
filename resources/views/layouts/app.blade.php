...
<head>
    ...
    <meta name="description" content="Saw">
...
<body>
<div id="app" class="page-holder {{request()->routeIs('detail')? 'bg-light' : null}}">
    <!-- navbar-->
    <header class="header bg-white">
        <div class="container px-lg-3">
            <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand" href="{{route('index')}}"><span
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu mt-3 shadow-sm" aria-labelledby="pagesDropdown">
                                ...
                                <a class="dropdown-item border-0 transition-link" href="{{route('detail')}}">Productdetail</a>
                                <a class="dropdown-item border-0 transition-link" href="{{route('cart')}}">Shopping
                                    cart</a><a class="dropdown-item border-0 transition-link" href="{{route('checkout')}}">Checkout</a>
                            </div>
                        </li>
                    </ul>
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item"><a class="nav-link" href="{{route('cart')}}"> <i class="fas fa-dolly-flatbed me-1 text-gray"></i>Cart<small
                                    class="text-gray fw-normal">(2)</small></a></li>
                        <li class="nav-item"><a class="nav-link" class="far fa-heart me-1"></i><small
                        ...
                        @else
                            ...
                            <li class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" id="authDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <i class="fa fa-user-alt mr-1 text-gray"></i>
                ...
                <div class="modal-body p-0">
                    <div class="row align-items-stretch">
                        <div class="col-lg-6 p-lg-0"><a class="glightbox product-view d-block h-100 bg-cover bg-center"
                                ...
                                class="glightbox d-none" href="{{asset('frontend/img/product-5-alt-1.jpg')}}" data-gallery="gallery1"
