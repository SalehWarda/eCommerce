        ...
        <div class="col-xl-12 mb-30">
            <div class="card card-statistics h-100">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{route('admin.countries.store')}}" autocomplete="off" >
                        @csrf
                        <div class="row">
                            <div class="col-md-9">
                        ...
                        <br>
                        <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="submit">Add Country
                        </button>
