        ...
        <div class="col-xl-12 mb-30">
            <div class="card card-statistics h-100">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{route('admin.customers_addresses.store')}}" autocomplete="off">
                        @csrf
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-lg mb-15" name="default_address">
                                        ...
                                        <option value=""> ---</option>
                                        <option value="1" {{old('default_address') == '1' ? 'selected' : null}}>Yes
                                        </option>
                                        <option value="0" {{old('default_address') == '0' ? 'selected' : null}}>No
                                        </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-lg mb-15" id="country_id" name="country_id">
                                        ...
                                        @foreach($countries as $country)
                                            <option
                                                value="{{$country->id}}" {{old('country_id') == $country->id ? 'selected' : null}}>{{$country->name}}</option>
