<div class="card-body">
    <form action="{{route('admin.customers_addresses')}}" method="get">
        <div class="row">
            <div class="col-2">
            ...
            <div class="col-2">
                <div class="form-group">
                    <select name="sort_by" class="custom-select my-1 mr-sm-2">
                        ...
                        <option value="first_name" {{old('sort_by',request()->input('sort_by')) == 'first_name' ? 'selected':''}}>Name</option>
            ...
            <div class="col-2">
                <div class="form-group ">
                    <button type="submit" name="submit" class="btn btn-info ml-70"><i class="fa fa-search"></i> Search</button>
                </div>
            </div>
        </div>
