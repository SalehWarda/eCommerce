...
@section('content')
    ...
    <section class="hero pb-3 bg-cover bg-center d-flex align-items-center"
             style="background: url({{asset('images/slides/hero-banner-alt.jpg')}})">
    ...
    <section class="pt-5">
        ...
        <div class="row">
            <div class="col-md-4"><a class="category-item" href="{{route('frontend.product',$product_categories[0]->slug)}}"><img class="img-fluid"
                                                                                      src="{{asset('frontend/img/cat-img-1.jpg')}}"
                                                                                      alt=""/><strong
                        class="category-item-title">Clothes</strong></a>
            </div>
            <div class="col-md-4"><a class="category-item mb-4" href="{{route('frontend.product',$product_categories[1]->slug)}}"><img class="img-fluid"
                                                                                           src="{{asset('frontend/img/cat-img-2.jpg')}}"
                                                                                           alt=""/><strong
                        class="category-item-title">Shoes</strong></a><a class="category-item"
                                                                         href="{{route('frontend.product',$product_categories[2]->slug)}}"><img class="img-fluid"
                                                                                                    src="{{asset('frontend/img/cat-img-3.jpg')}}"
                                                                                                    alt=""/><strong
                        class="category-item-title">Watches</strong></a>
            </div>
            <div class="col-md-4"><a class="category-item" href="{{route('frontend.product',$product_categories[3]->slug)}}"><img class="img-fluid"
