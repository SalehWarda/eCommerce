                        ...
                        <div class="col-lg-6">
                            <div wire:ignore class="p-4 my-md-4">
                                    ...
                                    @if($productModal->reviews_avg_rating != '')
                                        ...
                                        @for($i = 0 ; $i<5 ; $i++)
                                            ...
                                            <li class="list-inline-item m-0"><i
                                                    class=" {{round($productModal->reviews_avg_rating) <= $i ? 'far' : 'fas'}} fa-star small text-warning"></i>
                                            </li>
                                ...
                                <div class="row align-items-stretch mb-4 gx-0">
                                    ...
                                    <div class="col-sm-5">
                                        <a wire:click="addToCart()"  class="btn btn-dark btn-sm w-100 h-100 d-flex align-items-center justify-content-center px-0">Add to cart</a></div>
                                </div>
                                <a wire:click="addToWishList()"  class="btn btn-link text-dark text-decoration-none p-0" ><i
